    ...
    <section id="heat-predictor" style={{ background: '#040404', padding: '80px 20px', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 16, alignItems: 'center' }}>
          ...
          {POPULAR.map(s => (
            <button key={s} onClick={() => { setShoe(s); setResult(null) }} style={{ background: shoe === s ? `${B.neonCyan}15` : '#0d0d0d', border: `1px solid ${shoe === s ? B.neonCyan : '#1a1a1a'}`, color: shoe === s ? B.neonCyan : B.dim, fontFamily: "'Space Mono'", fontSize: 8, padding: '5px 12px', cursor: 'pointer', transition: 'all 0.15s' }}>
        ...
        <div style={{ display: 'flex', gap: 10, marginBottom: 24 }}>
          ...
          />
          <button onClick={predict} disabled={!shoe.trim() || loading} style={{ padding: '12px 22px', background: shoe.trim() && !loading ? B.neonCyan : '#111', color: shoe.trim() && !loading ? B.black : B.dim, border: 'none', fontFamily: "'Space Mono'", fontSize: 10, letterSpacing: '0.12em', fontWeight: 700, cursor: shoe.trim() && !loading ? 'pointer' : 'default', whiteSpace: 'nowrap', transition: 'all 0.2s' }}>
          ...
          <div style={{ animation: 'hpSlide 0.35s ease' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: 16, marginBottom: 16 }}>
              <div style={{ background: sc.bg, border: `2px solid ${sc.color}55`, padding: '24px 20px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
                ...
                <div style={{ fontFamily: "'Space Mono'", fontSize: 9, color: B.dim, letterSpacing: '0.1em', marginBottom: 12 }}>CONFIDENCE</div>
                <div style={{ fontFamily: "'Orbitron'", fontSize: 38, fontWeight: 900, color: sc.color, lineHeight: 1 }}>{result.confidence}</div>
                <div style={{ fontFamily: "'Space Mono'", fontSize: 8, color: B.dim }}>/ 100</div>
              </div>
              <div>
                <div style={{ background: '#0a0a0a', border: '1px solid #1a1a1a', padding: '12px 16px', marginBottom: 8 }}>
                  <div style={{ fontFamily: "'Space Mono'", fontSize: 9, color: B.dim, letterSpacing: '0.15em', marginBottom: 4 }}>CURRENT LAGOS PRICE</div>
                ...
                <div style={{ background: '#0a0a0a', border: '1px solid #1a1a1a', padding: '12px 16px' }}>
                  <div style={{ fontFamily: "'Space Mono'", fontSize: 9, color: B.dim, letterSpacing: '0.15em', marginBottom: 4 }}>GLOBAL TREND</div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 12 }}>
              <div style={{ background: '#0a0a0a', border: `1px solid ${B.amber}22`, padding: '14px 16px' }}>
                <div style={{ fontFamily: "'Space Mono'", fontSize: 9, color: B.amber, letterSpacing: '0.15em', marginBottom: 6 }}>6-MONTH OUTLOOK</div>
              ...
              <div style={{ background: '#0a0a0a', border: `1px solid ${B.neonCyan}22`, padding: '14px 16px' }}>
                <div style={{ fontFamily: "'Space Mono'", fontSize: 9, color: B.neonCyan, letterSpacing: '0.15em', marginBottom: 6 }}>12-MONTH OUTLOOK</div>
            ...
            <div style={{ background: '#0a0a0a', border: '1px solid #1a1a1a', padding: '14px 18px', marginBottom: 12 }}>
              <div style={{ fontFamily: "'Space Mono'", fontSize: 9, color: B.dim, letterSpacing: '0.15em', marginBottom: 8 }}>KEY FACTORS</div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 14 }}>
              <div style={{ background: '#1a0000', border: '1px solid #ef444422', padding: '12px 14px' }}>
                <div style={{ fontFamily: "'Space Mono'", fontSize: 9, color: '#ef4444', letterSpacing: '0.15em', marginBottom: 4 }}>MAIN RISK</div>
              ...
              <div style={{ background: '#0a0a0a', border: `1px solid ${B.neonLime}18`, padding: '12px 14px' }}>
                <div style={{ fontFamily: "'Space Mono'", fontSize: 9, color: B.neonLime, letterSpacing: '0.15em', marginBottom: 4 }}>🇳🇬 LAGOS TIP</div>
