    ...
    <section id="collector-card" style={{ background: '#040404', padding: '80px 20px', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: 700, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12, marginBottom: 8 }}>
          ...
          <div style={{ fontFamily: "'Space Mono'", fontSize: 9, color: '#444', letterSpacing: '0.15em' }}>LAGOS SNEAKER REGISTRY</div>
        </div>
        ...
        <div style={{ marginBottom: 20 }}>
          <div style={{ fontFamily: "'Space Mono'", fontSize: 8, color: '#333', letterSpacing: '0.2em', marginBottom: 12 }}>YOUR ROTATION (3–5)</div>
          {shoes.map((s, i) => (
          ...
          {shoes.length < 5 && (
            <button onClick={addShoe} style={{ background: 'transparent', border: '1px dashed #2a2a2a', color: '#333', fontFamily: "'Space Mono'", fontSize: 8, letterSpacing: '0.15em', padding: '8px 16px', cursor: 'pointer', marginTop: 4 }}>
              + ADD SHOE
            </button>
          )}
        </div>

        <button onClick={generate} disabled={filled.length < 3 || loading} style={{ width: '100%', padding: '14px', background: filled.length >= 3 && !loading ? B.amber : '#111', color: filled.length >= 3 && !loading ? B.black : '#333', border: 'none', fontFamily: "'Space Mono'", fontSize: 11, letterSpacing: '0.2em', fontWeight: 700, cursor: filled.length >= 3 && !loading ? 'pointer' : 'default', marginBottom: 24, transition: 'all 0.2s' }}>
        ...
        {result && rc && (
          <div style={{ animation: 'ccSlide 0.4s ease' }}>
            <div style={{ background: rc.bg, border: `2px solid ${rc.color}44`, padding: '28px 28px', marginBottom: 16, textAlign: 'center' }}>
              <div style={{ fontFamily: "'Space Mono'", fontSize: 8, color: '#333', letterSpacing: '0.25em', marginBottom: 10 }}>OFFICIAL COLLECTOR CARD</div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 20, marginBottom: 14 }}>
                ...
                <div>
                  <div style={{ fontFamily: "'Space Mono'", fontSize: 7, color: '#333', letterSpacing: '0.15em' }}>REP SCORE</div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 12 }}>
              <div style={{ background: '#0a0a0a', border: `1px solid ${B.amber}20`, padding: '12px 14px' }}>
                <div style={{ fontFamily: "'Space Mono'", fontSize: 7, color: B.amber, letterSpacing: '0.15em', marginBottom: 5 }}>SPECIALTY</div>
              ...
              <div style={{ background: '#0a0a0a', border: `1px solid ${B.neonCyan}20`, padding: '12px 14px' }}>
                <div style={{ fontFamily: "'Space Mono'", fontSize: 7, color: B.neonCyan, letterSpacing: '0.15em', marginBottom: 5 }}>SIGNATURE MOVE</div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 12 }}>
              <div style={{ background: '#0a0a0a', border: `1px solid ${B.neonLime}20`, padding: '12px 14px' }}>
                <div style={{ fontFamily: "'Space Mono'", fontSize: 7, color: B.neonLime, letterSpacing: '0.15em', marginBottom: 5 }}>LONGEST FLEX</div>
              ...
              <div style={{ background: '#1a0000', border: '1px solid #ef444418', padding: '12px 14px' }}>
                <div style={{ fontFamily: "'Space Mono'", fontSize: 7, color: '#ef4444', letterSpacing: '0.15em', marginBottom: 5 }}>WEAKEST LINK</div>
            ...
            <div style={{ background: '#0a0a0a', border: `1px solid ${'#A855F7'}20`, padding: '12px 16px', marginBottom: 12 }}>
              <div style={{ fontFamily: "'Space Mono'", fontSize: 7, color: '#A855F7', letterSpacing: '0.15em', marginBottom: 5 }}>AT SF26</div>
            ...
            <div style={{ background: '#0a0a0a', border: `2px solid ${rc.color}33`, padding: '16px 20px', marginBottom: 14 }}>
              <div style={{ fontFamily: "'Space Mono'", fontSize: 7, color: '#333', letterSpacing: '0.2em', marginBottom: 8 }}>YOUR IDENTITY</div>
