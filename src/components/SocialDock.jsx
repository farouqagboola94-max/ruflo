...
const PLATFORMS = [
  ...
  { id: 'instagram', label: 'INSTAGRAM',  abbr: 'IG', color: '#E1306C',     href: SOCIAL_LINKS.instagram,         tip: '@sneakersfest5555' },
...
export default function SocialDock() {
  ...
  // Hidden on mobile — WhatsAppButton + MobileCTA handle the right side
      ...
      {PLATFORMS.map(p => (
        ...
        >
          ...
          <div style={{
            ...
            transform: hovered === p.id ? 'translateX(0)' : 'translateX(6px)',
          ...
          <div style={{
            ...
            background: hovered === p.id ? p.color + '22' : B.charcoal,
            border: `1px solid ${hovered === p.id ? p.color + '90' : p.color + '35'}`,
            borderRadius: 4,
            transition: 'all 0.22s ease',
            boxShadow: hovered === p.id ? `0 0 16px ${p.color}25` : 'none',
            flexShrink: 0,
          }}>
            <span style={{
