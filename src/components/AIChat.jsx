...
const QA = [
  ...
  { keys: ['contact','reach','email','hello','hi'], answer: 'WhatsApp (bottom right) is fastest. Instagram @sneakersfest5555 · Snapchat: sneakersfest · press@sneakersfest.com for media · sponsors@sneakersfest.com for brands.' },
