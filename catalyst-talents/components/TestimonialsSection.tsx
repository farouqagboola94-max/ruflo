  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="mb-16">
          <p className="text-[#D4AF37] text-[10px] tracking-[0.4em] uppercase mb-3">Our Principles</p>
          ...
          {testimonials.map((t) => (
            ...
            >
              ...
              <div className="border-t border-white/5 pt-5">
                <p className="text-[#D4AF37]/80 text-xs font-semibold tracking-widest uppercase">{t.role}</p>
                <p className="text-white/30 text-xs mt-1">{t.company}</p>
              </div>
            </div>
          ))}
        </div>
