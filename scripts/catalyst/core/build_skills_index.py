#!/usr/bin/env python3
"""
CatalystOS Skills Index Builder
Aggregates skills from multiple sources into a unified master index.
"""
...
SKILLS = [
    ...
    {"id": "legal-001", "name": "Affidavit Drafter", "category": "Legal", "subcategory": "Document Drafting", "description": "Draft affidavits for Nigerian High Court with proper sworn statement format.", "tags": ["affidavit", "sworn", "court", "lagos"], "jurisdiction": "Nigeria"},
    {"id": "legal-002", "name": "Motion Writer", "category": "Legal", "subcategory": "Document Drafting", "description": "Draft motions and applications for filing in Nigerian courts.", "tags": ["motion", "court", "filing"], "jurisdiction": "Nigeria"},
    {"id": "legal-003", "name": "Brief Summarizer", "category": "Legal", "subcategory": "Research", "description": "Summarize legal briefs and case files into concise action points.", "tags": ["summary", "brief", "case"], "jurisdiction": "Nigeria"},
    {"id": "legal-004", "name": "Case Law Researcher", "category": "Legal", "subcategory": "Research", "description": "Research Nigerian case law and precedents for litigation support.", "tags": ["case law", "precedent", "research"], "jurisdiction": "Nigeria"},
    {"id": "legal-005", "name": "Contract Reviewer", "category": "Legal", "subcategory": "Review", "description": "Review contracts for red flags, missing clauses, and risk exposure.", "tags": ["contract", "review", "risk"], "jurisdiction": "Nigeria"},
    {"id": "legal-006", "name": "Witness Statement Drafter", "category": "Legal", "subcategory": "Document Drafting", "description": "Structure witness statements for court admissibility.", "tags": ["witness", "statement", "court"], "jurisdiction": "Nigeria"},
    {"id": "legal-007", "name": "Pleadings Formatter", "category": "Legal", "subcategory": "Formatting", "description": "Format pleadings to Lagos High Court filing standards.", "tags": ["pleadings", "format", "lagos"], "jurisdiction": "Nigeria"},
    {"id": "legal-008", "name": "Legal Letter Drafter", "category": "Legal", "subcategory": "Correspondence", "description": "Draft demand letters, notices, and legal correspondence.", "tags": ["letter", "demand", "notice"], "jurisdiction": "Nigeria"},
    {"id": "legal-009", "name": "Deposition Summarizer", "category": "Legal", "subcategory": "Research", "description": "Summarize depositions and transcripts into key points.", "tags": ["deposition", "transcript", "summary"], "jurisdiction": "Nigeria"},
    {"id": "legal-010", "name": "Court Filing Checklist", "category": "Legal", "subcategory": "Compliance", "description": "Generate filing checklists for specific court applications.", "tags": ["checklist", "filing", "compliance"], "jurisdiction": "Nigeria"},
    ...
    # --- EVENT MANAGEMENT (SNEAKERS FEST) ---
...
meta = {
    ...
    "os": "CatalystOS",
    "owner": "The Catalyst — Lagos, Nigeria"
}
...
# Save markdown
lines = [
    "# CatalystOS Master Skills Index",
    f"**Built:** {meta['built_at']}  ",
    f"**Total Skills:** {meta['total_skills']}  ",
...
with open("master-index.md", "w") as f:
    f.write("\n".join(lines))

print(f"✅ Built {len(SKILLS)} skills across {len(meta['categories'])} categories")
print(f"📄 Saved: master-index.json")
print(f"📄 Saved: master-index.md")
