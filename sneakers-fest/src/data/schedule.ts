...
export const SCHEDULE: ScheduleDay[] = [
  {
    ...
    events: [
      ...
      { id: 'd1-2', time: '10:00 AM', title: 'Vendor Floor Opens', description: '200+ vendors ready to trade, buy, and sell the hottest kicks.', location: 'Hall A & B', type: 'vendor', featured: true },
      ...
      { id: 'd1-5', time: '2:30 PM', title: 'Nike Exclusive Showcase', description: 'First look at unreleased Nike colorways for 2025.', location: 'Showcase Hall', type: 'showcase', featured: true },
  ...
  },
  {
    ...
    events: [
      ...
      { id: 'd2-5', time: '3:30 PM', title: 'Raffle Draw #2 — Grand Prize', description: 'Grand Prize: Signed Air Jordan 11 "72-10" + $500 gift card.', location: 'Main Stage', type: 'raffle', featured: true },
