...
export const FAQ: FaqItem[] = [
  { category: 'General', q: 'What is SneakersFest?', a: "SneakersFest is West Africa's premier sneaker culture event, bringing together collectors, sellers, and enthusiasts for two days of buying, selling, and celebrating kicks. The 2026 edition takes place December 12–13 at Lagos Convention Centre." },
  ...
  { category: 'Vendors', q: 'How do I get a vendor table?', a: 'Submit a listing via the Marketplace page. Vendor slots are ₦80,000 for 2 days and include a 6ft table and 2 vendor passes. Applications close December 5.' },
